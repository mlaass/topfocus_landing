...
alert('Gallery script is loading!');

// Test if we can find any gallery elements
console.log('Gallery thumbnails found:', document.querySelectorAll('.gallery-thumbnail').length);
console.log('Gallery data scripts found:', document.querySelectorAll('script.gallery-data').length);
class ModalGallery {
